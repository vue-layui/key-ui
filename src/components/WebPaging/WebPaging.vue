<template>
    <div class="BigBox">
        <h2>一.使用说明：</h2>
        <p class="state">首先引入jQuery和layui.all.js这两个js文件，然后再引入layui.css样式，,核心代码请看最后面
        </p>
        ...
        <!--核心代码-->
        <h2 style="margin-top: 15px">二.核心代码：</h2>
        <hr/>
        <div class="code">
            <P id="code_p">查看代码</P>
            <p id="code_b">隐藏代码</p>
    ...
    export default {
        ...
        mounted(){
            ...
            layui.use(['laypage', 'layer'], function(){
                ...
                //测试数据
                var data = ['北京', '上海', '广州', '深圳', '杭州', '长沙', '合肥', '宁夏', '成都',
                    '西安', '南昌', '上饶', '沈阳', '济南', '厦门', '福州', '九江', '宜春', '赣州',
                    '宁波', '绍兴', '无锡', '苏州', '徐州',
                    '东莞', '佛山', '中山', '成都', '武汉', '青岛', '天津', '重庆', '南京',
                    '九江', '香港', '澳门', '台北'
                ];
